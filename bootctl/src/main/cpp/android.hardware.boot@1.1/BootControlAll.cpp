#define LOG_TAG "android.hardware.boot@1.1::BootControl"
...
#include <android/hardware/boot/1.1/BnHwBootControl.h>
#include <android/hardware/boot/1.1/BsBootControl.h>
...
const char* IBootControl::descriptor("android.hardware.boot@1.1::IBootControl");
...
::android::hardware::Return<void> IBootControl::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::boot::V1_1::IBootControl::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::boot::V1_1::IBootControl>> IBootControl::castFrom(const ::android::sp<::android::hardware::boot::V1_1::IBootControl>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::boot::V1_1::IBootControl>> IBootControl::castFrom(const ::android::sp<::android::hardware::boot::V1_0::IBootControl>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBootControl, ::android::hardware::boot::V1_0::IBootControl, BpHwBootControl>(
            parent, "android.hardware.boot@1.1::IBootControl", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::boot::V1_1::IBootControl>> IBootControl::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwBootControl::BpHwBootControl(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBootControl>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.boot@1.1", "IBootControl") {
}
...
// Methods from ::android::hardware::boot::V1_1::IBootControl follow.
::android::hardware::Return<bool> BpHwBootControl::_hidl_setSnapshotMergeStatus(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::boot::V1_1::MergeStatus status) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IBootControl::setSnapshotMergeStatus::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.boot", "1.1", "IBootControl", "setSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(9 /* setSnapshotMergeStatus */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.boot", "1.1", "IBootControl", "setSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::boot::V1_1::MergeStatus> BpHwBootControl::_hidl_getSnapshotMergeStatus(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IBootControl::getSnapshotMergeStatus::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.boot", "1.1", "IBootControl", "getSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::boot::V1_1::MergeStatus _hidl_out_status;

    _hidl_err = _hidl_data.writeInterfaceToken(BpHwBootControl::descriptor);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(10 /* getSnapshotMergeStatus */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.boot", "1.1", "IBootControl", "getSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    return ::android::hardware::Return<::android::hardware::boot::V1_1::MergeStatus>(_hidl_out_status);

_hidl_error:
    _hidl_status.setFromStatusT(_hidl_err);
    return ::android::hardware::Return<::android::hardware::boot::V1_1::MergeStatus>(_hidl_status);
}
...
BnHwBootControl::BnHwBootControl(const ::android::sp<IBootControl> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.boot@1.1", "IBootControl") { 
...
// Methods from ::android::hardware::boot::V1_1::IBootControl follow.
::android::status_t BnHwBootControl::_hidl_setSnapshotMergeStatus(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBootControl::setSnapshotMergeStatus::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.boot", "1.1", "IBootControl", "setSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    bool _hidl_out_success = static_cast<IBootControl*>(_hidl_this->getImpl().get())->setSnapshotMergeStatus(status);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.boot", "1.1", "IBootControl", "setSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBootControl::_hidl_getSnapshotMergeStatus(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBootControl::getSnapshotMergeStatus::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.boot", "1.1", "IBootControl", "getSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::boot::V1_1::MergeStatus _hidl_out_status = static_cast<IBootControl*>(_hidl_this->getImpl().get())->getSnapshotMergeStatus();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.boot", "1.1", "IBootControl", "getSnapshotMergeStatus", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsBootControl::BsBootControl(const ::android::sp<::android::hardware::boot::V1_1::IBootControl> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.boot@1.1", "IBootControl"), mImpl(impl) {
...
bool IBootControl::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.boot@1.1::IBootControl",
