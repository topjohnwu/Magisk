#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BOOT_V1_2_BPHWBOOTCONTROL_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BOOT_V1_2_BPHWBOOTCONTROL_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/boot/1.2/IHwBootControl.h>
...
struct BpHwBootControl : public ::android::hardware::BpInterface<IBootControl>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<uint32_t>  _hidl_getActiveBootSlot(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BOOT_V1_2_BPHWBOOTCONTROL_H
