#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BOOT_V1_2_IBOOTCONTROL_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BOOT_V1_2_IBOOTCONTROL_H
...
struct IBootControl : public ::android::hardware::boot::V1_1::IBootControl {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.boot@1.2::IBootControl"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::boot::V1_2::IBootControl>> castFrom(const ::android::sp<::android::hardware::boot::V1_2::IBootControl>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::boot::V1_2::IBootControl>> castFrom(const ::android::sp<::android::hardware::boot::V1_1::IBootControl>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::boot::V1_2::IBootControl>> castFrom(const ::android::sp<::android::hardware::boot::V1_0::IBootControl>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::boot::V1_2::IBootControl>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::boot::V1_2::IBootControl>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::boot::V1_2::IBootControl>& o) {
    ...
    os += ::android::hardware::boot::V1_2::IBootControl::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BOOT_V1_2_IBOOTCONTROL_H
