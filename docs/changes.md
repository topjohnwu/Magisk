...
- [一般的]将最低支持的安卓版本提升到Android6.0
- [一般的]新的魔术坐骑后端，支持将模块加载到系统`overlayfs`插入的文件
- [Zygisk]发布新API版本4
- [Zygisk]防止出现错误时使守护程序崩溃
- [Zygisk]用新的加载程序库方法重写合子代码注入
- [Zygisk]重写代码卸载实现
- [MagiskBoot]支持阿莫内微型装载机装置
...
- [应用程序]使存根修补程序100%脱机
- [应用程序]支架修补`init_boot.img`用于三星ODIN固件
