...
- Add systemless host support for AdBlock Apps (enabled by defa# Magisk Changelog# Magisk Changelog
...
- All scripts will now run in selinux permissive mode for maximum compatibility (this will **NOT** turn your device to permissive)
- Add Nougat Developer Preview 5 support
- Add systemless host support for AdBlock Apps (enabled by defa# Magisk Changelog
